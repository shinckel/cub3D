...
/*   Updated: 2024/09/03 19:45:37 by shinckel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	is_collision(t_game *game, double new_x, double new_y)
{
	...
	m = 0.04;
	if (game->config.map[(int)(new_y)][(int)(new_x)] == ' '
		|| game->config.map[(int)(new_y + m)][(int)(new_x + m)] == '\0'
		|| game->config.map[(int)(new_y + m)][(int)(new_x + m)] == '\n')
		return (1);
	if (game->config.map[(int)(new_y + m)][(int)(new_x + m)] == '1'
		|| game->config.map[(int)(new_y + m)][(int)(new_x + m)] == '\0'
		|| game->config.map[(int)(new_y + m)][(int)(new_x + m)] == ' '
		|| game->config.map[(int)(new_y + m)][(int)(new_x + m)] == '\n')
		return (1);
